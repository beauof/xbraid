...
/**
 * Set the periodicity of all time grids.
 * By default, all time-grids are non-periodic.
 **/
braid_Int
braid_SetTimeGridPeriodicity(braid_Core     core,            /**< braid_Core (_braid_Core) struct */
                             braid_Int      periodic_tgrid   /**< periodicity of time grids */
                            );
